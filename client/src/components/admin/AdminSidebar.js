    ...
    <div className='col-lg-2 col-md-3 sidebar p-0'>
      <div className='container-fluid p-0'>
        ...
        <div className='p-2 pt-3 mt-2'>
          <div className={'row mx-1 menuItem rounded p-1 cursor-pointer mt-1 ' + (currentPage === 'patients' ? 'selected' : '')} onClick={() => goPage('patients')}>
            <div className='d-flex align-items-center justify-content-between'>
              <i className="material-icons mr-4">people_outline</i>
              <div className='p mb-0'>Patients</div>
            </div>
          </div>
