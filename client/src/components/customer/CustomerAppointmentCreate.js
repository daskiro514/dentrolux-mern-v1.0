...
const CustomerAppointmentCreate = ({ userID, createAppointment, setAlert }) => {
			...
			<div className='row admin-header align-items-center py-2'>
				<div className='col-md-12 py-2'>
					<div className='d-flex flex-row'>
						<div className='logo py-2'>New Appointment</div>
					</div>
				</div>
			</div>
...
export default connect(mapStateToProps, { createAppointment, setAlert })(CustomerAppointmentCreate)